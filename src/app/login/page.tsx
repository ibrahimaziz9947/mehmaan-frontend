...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Mock client-side login behavior
    console.log("Login attempted with:", { email, password });
    alert("Mock Login Successful! Backend integration coming soon.");
  };
  ...
  return (
    <AuthLayout
      ...
      imageUrl="https://images.unsplash.com/photo-1542314831-c6a4d1409385?auto=format&fit=crop&q=80&w=1200"
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-surface px-4 text-muted-foreground">Or continue with</span>
          </div>
        </div>
